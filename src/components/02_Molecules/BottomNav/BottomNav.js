        ...
        <Footer>
          <FooterTab style={{ backgroundColor: 'black' }}>
            ...
            <Button onPress={() => { (props.active === 'AdminHome') ? props.navigation.navigate('AdminHome') : props.navigation.reset({ index: 0, routes: [{ name: 'AdminHome' }] }) }}>
              ...
              <Text style={[styles.BottomNav__item, (props.active === 'AdminHome') ? { color: 'white' } : null]}>Pending</Text>
            </Button>
            ...
            <Button onPress={() => { (props.active === 'Report') ? props.navigation.navigate('Report') : props.navigation.reset({ index: 0, routes: [{ name: 'Report' }] }) }}>
              ...
              <Text style={[styles.BottomNav__item, (props.active === 'Report') ? { color: 'white' } : null]}>Report</Text>
            </Button>
            ...
            <Button onPress={() => { (props.active === 'Active') ? props.navigation.navigate('Active') : props.navigation.reset({ index: 0, routes: [{ name: 'Active' }] }) }}>
              ...
              <Text style={[styles.BottomNav__item, (props.active === 'Active') ? { color: 'white' } : null]}>Active</Text>
            </Button>
            ...
            { user_logged_in(user) ? <Button onPress={() => { (props.active === 'Host') ? props.navigation.navigate('HostDashboard') : props.navigation.reset({ index: 0, routes: [{ name: 'HostDashboard' }] }) }}>
              ...
              <Text style={[styles.BottomNav__item, (props.active === 'Host') ? { color: 'white' } : null]}>Host</Text>
            </Button> :
            ...
            <Button onPress={() => (user_logged_in(user)) ? props.navigation.navigate('Profile') : props.navigation.navigate('NotLogin')}>
              ...
              <Text style={[styles.BottomNav__item, (props.active === 'Account') ? { color: 'white' } : null]}>Account</Text>
            </Button>
          </FooterTab>
        </Footer>
      </View>
      ...
      <Footer>
        <FooterTab style={{ backgroundColor: 'black' }}>
          ...
          <Button onPress={() => { (props.active === 'Home') ? props.navigation.navigate('Home') : props.navigation.reset({ index: 0, routes: [{ name: 'Home' }] }) }}>
            ...
            <Text style={[styles.BottomNav__item, (props.active === 'Home') ? { color: 'white' } : null]}>Home</Text>
          </Button>
          ...
          <Button onPress={() => { (props.active === 'Social') ? props.navigation.navigate('Social') : props.navigation.reset({ index: 0, routes: [{ name: 'Social' }] }) }}>
            ...
            <Text style={[styles.BottomNav__item, (props.active === 'Social') ? { color: 'white' } : null]}>Social</Text>
          </Button>
          ...
          <Button onPress={() => { (props.active === 'Search') ? props.navigation.navigate('Search') : props.navigation.reset({ index: 0, routes: [{ name: 'Search' }] }) }}>
            ...
            <Text style={[styles.BottomNav__item, (props.active === 'Search') ? { color: 'white' } : null]}>Search</Text>
          </Button>
