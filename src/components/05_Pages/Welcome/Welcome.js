...
export default function HomeScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={fonts.h1}>Daily Live Drawings for the Hottest Sneakers and Collectables</Text>
      <Text style={[fonts.h3, { fontWeight: 'normal', width: '88%', marginTop: '2%' }]}>Donate to Important Causes and Win</Text>
